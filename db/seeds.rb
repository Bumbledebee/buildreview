...
TestValue.create([{name:"Success", test_id:1, result_status_id:4 , suggestion:""}])
TestValue.create([{name:"Failure", test_id:1 , result_status_id:1 , suggestion:"Please review build. Without app starting no testing."}])
TestValue.create([{name:"Yes, appid matches", test_id:2 , result_status_id:4 , suggestion:""}])
TestValue.create([{name:"No, appid does not match", test_id:2 , result_status_id:3 , suggestion:"Please double-check with dashboard you are testing what you wanted"}])
TestValue.create([{name:"Yes app version is visible", test_id:3 , result_status_id:4 , suggestion:""}])
TestValue.create([{name:"No app version is not visible", test_id:3 , result_status_id:3 , suggestion:"For debugging purposes better if it is visible"}])
TestValue.create([{name:"Yes, SDK version is the latest", test_id:4 , result_status_id:4 , suggestion:""}])
TestValue.create([{name:"No, SDK version is not the latest", test_id:4 , result_status_id:2 , suggestion:"Update to the latest SDK"}])
TestValue.create([{name:"Yes, the device identifier is visible (GAID or IDFA)", test_id:5 , result_status_id:4 , suggestion:""}])
TestValue.create([{name:"No, the device identifier is not visible (GAID or IDFA)", test_id:5 , result_status_id:1 , suggestion:"Correct build to send device identifiers"}])
TestValue.create([{name:"Yes, UserID is unique", test_id:6 , result_status_id:4 , suggestion:""}])
TestValue.create([{name:"No,UserID is not unique per user", test_id:6 , result_status_id:1 , suggestion:"Correct build to have unique UserIds"}])
TestValue.create([{name:"Success", test_id:7 , result_status_id:4 , suggestion:""}])
TestValue.create([{name:"Credentials missings", test_id:7 , result_status_id:2 , suggestion:"Add correct credentials in the Fyber Dashboard"}])
TestValue.create([{name:"Adapter missing", test_id:7 , result_status_id:2, suggestion:"Correct build to include adapter"}])
TestValue.create([{name:"Adapter incompatible", test_id:7 , result_status_id:2 , suggestion:"Correct build to use compatible adapter with Fyber SDK version"}])
TestValue.create([{name:"Yes, adapter verion is the latest", test_id:8 , result_status_id:4 , suggestion:""}])
TestValue.create([{name:"No, adapter version is not the latest", test_id:8 , result_status_id:2 , suggestion:"Correct build to include latest adapter version"}])
TestValue.create([{name:"Offer Wall is integrated", test_id:9 , result_status_id:4 , suggestion:""}])
TestValue.create([{name:"Offer Wall is not integrated", test_id:9 , result_status_id:1 , suggestion:"Offer Wall is not integrated into this build and cannot be tested"}])
TestValue.create([{name:"OFW screenshots are up to date", test_id:10 , result_status_id:4 , suggestion:""}])
TestValue.create([{name:"OFW screenshots are outdated", test_id:10 , result_status_id:2 , suggestion:""}])
TestValue.create([{name:"Loaded", test_id:11 , result_status_id:4 , suggestion:""}])
TestValue.create([{name:"Did not load", test_id:11 , result_status_id:1 , suggestion:"The Offer Wall did not load correctly"}])
TestValue.create([{name:"ATS blocked", test_id:11 , result_status_id:1 , suggestion:"Fix build to allow ATS to allow loading of Offer Wall"}])
TestValue.create([{name:"Fill loaded with offers", test_id:12 , result_status_id:4 , suggestion:""}])
TestValue.create([{name:"Loaded empty", test_id:12 , result_status_id:1 , suggestion:"The Offer Wall did not provide any fill"}])
TestValue.create([{name:"Closed", test_id:13 , result_status_id:4 , suggestion:""}])
TestValue.create([{name:"Error closing", test_id:13 , result_status_id:1 , suggestion:"Fix build to close offer wall correctly"}])
TestValue.create([{name:"Crashed Closing", test_id:13 , result_status_id:1, suggestion:"Fix build to close offer wall correctly"}])
TestValue.create([{name:"Closed on Return", test_id:14 , result_status_id:4 , suggestion:""}])
TestValue.create([{name:"Open on Return", test_id:14 , result_status_id:2 , suggestion:"Can cause confusion, please close OFW"}])
TestValue.create([{name:"Rewarded", test_id:15 , result_status_id:4 , suggestion:""}])
TestValue.create([{name:"Not Rewarded", test_id:15 , result_status_id:1 , suggestion:"Fix build to reward user after offer completion"}])
TestValue.create([{name:"Not Rewarded", test_id:16 , result_status_id:4 , suggestion:""}])
TestValue.create([{name:"Rewarded", test_id:16 , result_status_id:1 , suggestion:""}])
TestValue.create([{name:"Rewarding Obvious", test_id:17 , result_status_id:4 , suggestion:""}])
TestValue.create([{name:"Rewarding Confusion", test_id:17 , result_status_id:3 , suggestion:"Fix build to make rewarding obvious to avoid users being confused and complaining to cusotmer support"}])
TestValue.create([{name:"Integrated", test_id:18 , result_status_id:4 , suggestion:""}])
TestValue.create([{name:"Not Integrated", test_id:18 , result_status_id:1 , suggestion:"Rewarded Video does not seem integrated in this build"}])
TestValue.create([{name:"Up to date", test_id:19 , result_status_id:4 , suggestion:""}])
TestValue.create([{name:"Outdate", test_id:19 , result_status_id:3 , suggestion:""}])
TestValue.create([{name:"Enabled", test_id:20 , result_status_id:4 , suggestion:""}])
TestValue.create([{name:"Disabled", test_id:20 , result_status_id:1 , suggestion:"Pre-caching is not enabled on this build"}])
TestValue.create([{name:"Not requesting on Startup", test_id:21 , result_status_id:4 , suggestion:""}])
TestValue.create([{name:"Requesting on Startup", test_id:21 , result_status_id:1, suggestion:"The first request is made to soon after app start"}])
TestValue.create([{name:"Correct Behaviour", test_id:22 , result_status_id:4 , suggestion:""}])
TestValue.create([{name:"Incorrect Behaviour", test_id:22 , result_status_id:1 , suggestion:""}])
TestValue.create([{name:"ATS blocked", test_id:22 , result_status_id:1 , suggestion:""}])
TestValue.create([{name:"Correct Behaviour", test_id:23 , result_status_id:4 , suggestion:""}])
TestValue.create([{name:"Incorrect Behaviour", test_id:23 , result_status_id:1 , suggestion:""}])
TestValue.create([{name:"Infinite Loop", test_id:23 , result_status_id:1 , suggestion:""}])
